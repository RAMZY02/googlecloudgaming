...
import 'package:steppa/auth/Controller/staff_controller.dart';

class SteppaLogin extends StatefulWidget {
  const SteppaLogin({super.key});

  @override
  _SteppaLoginState createState() => _SteppaLoginState();
}

class _SteppaLoginState extends State<SteppaLogin> {
  final _formKey = GlobalKey<FormState>();
  final StaffController customerController = StaffController(); // Initialize Customer_Controller
    ...
    if (form != null && form.validate()) {
      ...
      try {
        ...
        if (result == "Login successful.") {
          ...
          Navigator.pushReplacementNamed(context, '/steppa');
        } else {
          setState(() {
